...
def main():
    ...
    clone_repo(repo_url='https://github.com/comfyanonymous/ComfyUI.git', target_dir='ComfyUI', commit_hash='f7a5107784cded39f92a4bb7553507575e78edbe')
    ...
    download_file(repo_id='tau-vision/insightface-antelopev2', filename='antelopev2.zip', local_dir='ComfyUI/models/insightface/models', cache_dir='ComfyUI/models/caches')
    if not os.path.exists('ComfyUI/models/insightface/models/antelopev2'):
        subprocess.run(['unzip', 'ComfyUI/models/insightface/models/antelopev2.zip', '-d', 'ComfyUI/models/insightface/models'], check=True)
